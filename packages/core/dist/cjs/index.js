...
var e = require('craftjs-utils-with-improvements'),
  t = require('react'),
...
var w = ['actions', 'query', 'connectors'];
function j(n) {
...
const L = ({ render: e }) => {
  ...
  q = ({ render: e }) => {
    const { hidden: t } = j((e) => ({ hidden: e.data.hidden })),
      { onRender: n } = k((e) => ({ onRender: e.options.onRender }));
    return t
      ? null
...
function G(e) {
  const { connectors: n, actions: r, query: o, store: a, ...i } = k(e),
    d = $(r);
  return {
    connectors: n,
    actions: t.useMemo(
...
const ye = () => {
    const { indicator: n, indicatorOptions: r, enabled: o } = k((e) => ({
